...
var GameLayer = cc.Layer.extend({
    ...
    init: function () {
        ...
        backMenu.setPosition(cc.p(30, winSize.height - 85));
        ...
        refreshMenu.setPosition(cc.p(90, winSize.height - 85));
        ...
        var scoreLabel = cc.LabelTTF.create("0", "#", 50, cc.size(0, 0), cc.TEXT_ALIGNMENT);
        scoreLabel.setPosition(cc.p(winSize.width - 158, winSize.height - 20 ));
        scoreLabel.schedule(function () {
            var showingScore = parseInt(scoreLabel.getString());
            if (showingScore < b2.getUserScore()) {
                scoreLabel.setString((showingScore + 10)
                    .toString());
            }
        });
